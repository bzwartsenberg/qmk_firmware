...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
        ...
        KC_Z,    KC_X,    GUI_C,    ALT_V,    KC_B,                                         KC_N,    ALT_M,    GUI_COMM, KC_DOT,  KC_QUOT,
                          KC_LBRC, KC_RBRC,                                                        KC_MINS, KC_EQL,
                                                 LT(SYMB,  KC_ESC), KC_ENT,  KC_TAB,  KC_BSPC, KC_SPC, LT(NAV, KC_GRV),
    ...
    [SYMB] = LAYOUT(
        ...
        KC_EXLM , KC_HASH , KC_LCBR , KC_RCBR , KC_TILD ,                                      KC_AMPR , KC_LBRC , KC_RBRC , KC_PERC , KC_PIPE,
                 QK_BOOT, _______,                                                                          KC_MB1,  KC_MB2,
                                                 KC_ESC, KC_ENT,  KC_TAB,  KC_BSPC, KC_SPC, LT(NAV, KC_GRV),
                                                          KC_LSFT,  KC_LGUI,  KC_LCTL,  KC_LALT
    ),
    ...
    [NAV] = LAYOUT(
        ...
        KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                                      KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,
                 KC_F11,  KC_F12,                                                                           _______, QK_BOOT,
                                                 LT(SYMB,  KC_ESC), KC_ENT,  KC_TAB,  KC_BSPC, KC_SPC, KC_GRV,
                                                          KC_LSFT,  KC_LGUI,  KC_LCTL,  KC_LALT
    )
};
